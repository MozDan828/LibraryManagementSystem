                            ...
                            <div class="md-card">
                                <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                                    ...
                                    <div class="user_heading_content">
                                        <h2 class="heading_b"><span class="uk-text-truncate" id="user_edit_uname"><?php echo $row->l_name;?></span><span class="sub-heading" id="user_edit_position">Staff @Library Inc</span></h2>
                                    </div>
